(function (global, factory) {
    ...
    class ClickTrackEvent extends TrackEvent {
        constructor(props) {
            super(props);
    ...
    class TrackViewEvent extends TrackEvent {
        constructor(props) {
            super(props);
    ...
    function adapt(element, options) {
      ...
      if (commonjsGlobal.document) {
        ...
        commonjsGlobal.document = options.context || function () {
          var root = element;
          while (root.parent) {
            root = root.parent;
          }
    ...
    function match(node, options) {
      ...
      Object.keys(ignore).forEach(function (type) {
        ...
        if (typeof predicate === 'string') {
          predicate = new RegExp((0, utilities.escapeValue)(predicate).replace(/\\/g, '\\\\'));
        }
    ...
    function findAttributesPattern(priority, element, ignore) {
      ...
      for (var i = 0, l = sortedKeys.length; i < l; i++) {
        ...
        var attributeValue = (0, utilities.escapeValue)(attribute.value);
    ...
    var _adapt2 = _interopRequireDefault(adapt_1);
    ...
    function optimize(selector, elements) {
      ...
      if (!Array.isArray(elements)) {
        elements = !elements.length ? [elements] : (0, utilities.convertNodeList)(elements);
      }
    ...
    var common_1 = common.getCommonAncestor;
    var common_2 = common.getCommonProperties;
    ...
    var _match2 = _interopRequireDefault(match_1);



    var _optimize2 = _interopRequireDefault(optimize_1);
    ...
    function getMultiSelector(elements) {
      ...
      if (!Array.isArray(elements)) {
        elements = (0, utilities.convertNodeList)(elements);
      }
      ...
      var ancestor = (0, common.getCommonAncestor)(elements, options);
      ...
      var selectorMatches = (0, utilities.convertNodeList)(document.querySelectorAll(selector));
    ...
    function getCommonSelectors(elements) {
      var _getCommonProperties = (0, common.getCommonProperties)(elements),
    ...
    var select_1 = select.getSingleSelector;
    var select_2 = select.getMultiSelector;
    ...
    Object.defineProperty(exports, 'getSingleSelector', {
      enumerable: true,
      get: function get() {
        return select.getSingleSelector;
      }
    });
    Object.defineProperty(exports, 'getMultiSelector', {
      enumerable: true,
      get: function get() {
        return select.getMultiSelector;
      }
    });

    var _select3 = _interopRequireDefault(select);



    var _optimize3 = _interopRequireDefault(optimize_1);



    var _common = _interopRequireWildcard(common);
    ...
    unwrapExports(lib);
    var lib_1 = lib.common;
    var lib_2 = lib.optimize;
    var lib_3 = lib.getMultiSelector;
    var lib_4 = lib.getSingleSelector;
    var lib_5 = lib.select;

    function collectCommonInfo() {
        const global = window;
        const path = global.location.pathname;
        const refer = global.document.referrer;
        return {
            path,
            refer
        };
    ...
    function collectClick (e) {
        ...
        const event = new ClickTrackEvent(props);
        return event;
    }
    ...
    class Collector extends EventEmit {
        constructor(types) {
            super();
    ...
    Collector.COLLECT_EVENT_NAME = 'collector:collect';

    class Storage extends EventEmit {
        constructor(tracks) {
            super();
            this.tracks = tracks || [];
        }
    ...
    class Storage$1 extends EventEmit {
        constructor() {
            super();
            // 初始化存储器
            this.storage = new Storage();
            // 监听存储事件，将track对象存储至存储器
            this.addEventListener(Storage$1.SAVE_EVENT_NAME, (e) => {
                let track = e.detail;
                this.storage.save(track);
            });
        }
    }
    Storage$1.SAVE_EVENT_NAME = 'storage:save';
    ...
    function watch(types) {
        ...
        collector.addEventListener(Collector.COLLECT_EVENT_NAME, (e) => {
            const { event } = e.detail;
            const track = new Track(event, user);
            storage.emit(Storage$1.SAVE_EVENT_NAME, track);
        });
        return {
            collector,
            storage
